...
def read_tf_records(filename, img_w=512, img_h=512, num_channels=1, num_grids=13 , batch_size=32):
		...
		batch = tf.train.shuffle_batch([serialized_example], batch_size=batch_size, capacity=min_queue_examples+100*batch_size, num_threads=4, 
